...
"start")
	...
	chroot /x86 qemu-x86_64-static /usr/bin/bash -c "source /xilinx/Vivado_Lab/2023.1/settings64.sh ; hw_server -s tcp:10.1.10.65:3121"
...
"debug")
	...
	test -z $( mount | grep "/x86/dev" ) && mount -o bind /dev /x86/dev
	test -z $( mount | grep "/x86/dev/pts" ) && mount -t devpts /dev/pts /x86/dev/pts
	chroot /x86 qemu-x86_64-static /usr/bin/bash -c "source /xilinx/Vivado_Lab/2023.1/settings64.sh ; hw_server -L/var/hw_server.log -lprotocol -s tcp:10.1.10.65:3121"
	;;
*)
	echo "FAILED"
	;;
